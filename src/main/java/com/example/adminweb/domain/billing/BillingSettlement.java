...
@Entity
@Table(name = "billing_settlements",
    uniqueConstraints = {@UniqueConstraint(name = "uk_billing_settlements_user_month",
...
public class BillingSettlement {
  ...
  @Builder
  private BillingSettlement(Long batchRunId, String targetMonth, Long userId, String detailJson,
      Integer finalAmount) {
